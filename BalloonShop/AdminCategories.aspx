...
<asp:Content ID="Content2" ContentPlaceHolderID="adminPlaceHolder" Runat="Server">
  ...
  <asp:GridView ID="grid" runat="server" DataKeyNames="CategoryID" 
    ...
    <Columns>
      ...
      <asp:TemplateField>
        <ItemTemplate>
          <asp:HyperLink runat="server" ID="link" NavigateUrl='<%# "AdminProducts.aspx?DepartmentID=" + Request.QueryString["DepartmentID"] + "&amp;CategoryID=" + Eval("CategoryID")%>' Text="Покажи продуктите">
          </asp:HyperLink>
        </ItemTemplate>
      </asp:TemplateField>
  ...
  <p><asp:Button ID="createCategory" Text="Създай" runat="server" 
