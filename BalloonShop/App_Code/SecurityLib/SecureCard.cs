...
namespace SecurityLib
{
  public class SecureCard
  {
    ...
    private void EncryptData()
    {
      ...
      {
       throw new SecureCardException("Не можахме да криптираме данните.");
      }
    }
    ...
    private void DecryptData()
    {
      ...
      {
          throw new SecureCardException("Не можахме да декриптираме данните.");
      }
    }
    ...
    public string CardHolder
    {
      get
      {
        ...
        {
          throw new SecureCardException("Данните не бяха декриптирани.");
        }
      }
    }
